...
\textbf{Celkové priemerné hodnotenie všetkých úloh:} 4.46 / 5

% Insert grap

\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{testing1\_graf.pdf}
    \caption{Grafické zobrazenie výsledkov užívateľského testovania 1}
\end{figure}
\end{document}
