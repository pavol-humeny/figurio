      ...
      <div v-if="editorStore.selectedTabPerTool[editorStore.selectedToolKey] === 'myPresets'" class="specific-settings">
        ...
        <div class="settings-content-wrapper"
          ...
          <div class="content-wrapper">
            ...
            <div class="content-aligned two-items" v-if="localImageFrame.enabled && isPhoneFrame(localImageFrame.type)"
              :class="!isModifyingPreset ? 'disabled' : ''">
              <p>
                {{ t('tools.preset.settings.myPresets.presetValues.frame.phoneFrameOrientation.label') }}
              </p>
              <DropdownSelect v-model="localImageFrame.phoneFrameOrientation" :options="phoneFrameOrientationOptions" />
            </div>
            <!-- Phone outline -->
            <div class="content-aligned two-items" v-if="localImageFrame.enabled && isPhoneFrame(localImageFrame.type)"
              :class="!isModifyingPreset ? 'disabled' : ''">
            ...
            <div class="content-aligned two-items"
              ...
              <NumberInput ref="frameWidthRef" v-model="localImageFrame.widthMm" :min="1" :max="50" :step="1" unit="mm"
                icon="IconArrowWidth" :iconTop="45" :onReset="() => localImageFrame.widthMm = 1"
                :disabled="!isModifyingPreset || (localImageFrame.type !== 'frameSolid' && !localImageFrame.outlineEnabled)" />
            </div>
            ...
            <div
              ...
              <DropdownSelect v-model="localImageFrame.phoneBatteryIconStyle" :options="phoneBatteryIconStyleOptions" />
            </div>
            <!-- Background color -->
            <div
            ...
            <div class="content-aligned two-items"
              ...
              <NumberInput ref="frameWidthRef" v-model="localImageFrame.headerSizeMm" :min="1" :max="50" :step="1"
                icon="IconArrowHeight" :iconTop="45" unit="mm" :disabled="!isModifyingPreset" />
            </div>
        ...
        <div v-if="isShowManualPresetSetting" class="settings-content-wrapper">
          <div class="content-wrapper">
            ...
            <div class="content-aligned two-items">
              ...
              <ToggleButton v-model="newPreset.resizeEnabled" :scale="0.6" :style="{ transform: 'translateX(16px)' }" />
            </div>
            <div class="content-inputs">
        ...
        <div v-if="isShowManualPresetSetting" class="settings-content-wrapper settings-content-wrapper-last">
          <div class="content-wrapper">
            ...
            <div v-if="isPhoneFrame(newPreset.frame.type) && newPreset.frame.enabled" class="content-aligned two-items">
              ...
              <DropdownSelect v-model="newPreset.frame.phoneFrameOrientation" :options="phoneFrameOrientationOptions" />
            </div>
            <!-- Use phone outline -->
            <div v-if="isPhoneFrame(newPreset.frame.type) && newPreset.frame.enabled" class="content-aligned two-items">
              <p>
            ...
            <div
              ...
              <NumberInput ref="frameWidthRef" v-model="newPreset.frame.widthMm" :min="1" :max="50" :step="1" unit="mm"
                icon="IconArrowWidth" :iconTop="45" :onReset="() => newPreset.frame.widthMm = 1"
                :disabled="!newPreset.frame.enabled" />
            </div>
            ...
            <div
              ...
              <DropdownSelect v-model="newPreset.frame.phoneBatteryIconStyle" :options="phoneBatteryIconStyleOptions" />
            </div>
            <!-- Background color -->
            <div
            ...
            <div
              ...
              <NumberInput ref="frameWidthRef" v-model="newPreset.frame.headerSize" :min="1" :max="100" :step="1"
                icon="IconArrowHeight" :iconTop="45" unit="px" />
            </div>
            ...
            <div
              ...
              <NumberInput ref="frameWidthRef" v-model="newPreset.frame.headerSizeMm" :min="1" :max="50" :step="1"
                icon="IconArrowHeight" :iconTop="45" unit="mm" />
            </div>
