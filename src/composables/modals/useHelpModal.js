 ...
 * }}
 */
export function useHelpModal(uiStore, router, t) {
  /**
  ...
  const startTutorial = () => {
    ...
    useInteractiveTutorial(uiStore, router, t).startTutorial()
  }
  ...
  const continueTutorial = () => {
    ...
    useInteractiveTutorial(uiStore, router, t).continueTutorial()
  }
